...
public class FlowTaskServiceApiImpl implements FlowTaskServiceApi {
  ...
  public FlowTaskHist history(Execution execution, CustomModel model) throws Exception {
    ...
    java.lang.Integer parentTaskId = execution.getTask() == null ? null : execution.getTask().getId();
   ...
   */
  public List<FlowTask> getNextActiveTasks(Integer flowOrderId, String taskName, Integer parentTaskId)
      throws Exception {
