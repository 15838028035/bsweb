...
public class FlowProcessServiceImpl<FlowProcess> extends BaseServiceImpl<FlowProcess>
    implements FlowProcessService<FlowProcess>, Serializable {

  private  final Log log = LogFactory.getLog(FlowProcessServiceImpl.class);
  ...
  public void redeploy(String id, InputStream input) {
    Assert.notNull(input);
    try {
      com.lj.app.core.common.flows.entity.FlowProcess entity = (com.lj.app.core.common.flows.entity.FlowProcess) this
          .getProcessById(id);
