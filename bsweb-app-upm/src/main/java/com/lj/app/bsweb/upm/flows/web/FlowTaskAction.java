...
@Namespace("/jsp/flows")
@Results({
	    @Result(name = AbstractBaseAction.RELOAD, location = "flowTaskAction", type = AbstractBaseAction.REDIRECT),
...
public class FlowTaskAction extends AbstractBaseUpmAction<FlowTask> {
	...
	/*	flowEngineFacets.getEngine().query().getHistoryWorkItems(page, 
