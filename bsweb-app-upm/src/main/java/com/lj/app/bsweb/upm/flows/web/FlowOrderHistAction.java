...
@Namespace("/jsp/flows")
@Results({
	    @Result(name = AbstractBaseAction.RELOAD, location = "flowOrderHistAction", type = AbstractBaseAction.REDIRECT),
		@Result(name = AbstractBaseAction.INPUT, location = "/jsp/flows/flowOrderHist-input.jsp"),
		@Result(name = AbstractBaseAction.SAVE, location = "flowOrderHistAction!edit.action",type=AbstractBaseAction.REDIRECT),
		@Result(name = AbstractBaseAction.LIST, location = "/jsp/flows/flowOrderHistList.jsp", type=AbstractBaseAction.REDIRECT)
})
