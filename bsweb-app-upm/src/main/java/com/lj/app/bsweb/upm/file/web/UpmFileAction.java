...
@Results({
	    @Result(name = AbstractBaseAction.RELOAD, location = "upmFileAction", type = AbstractBaseAction.REDIRECT),
		@Result(name = AbstractBaseAction.INPUT, location = "/jsp/upmFile/upmFile-input.jsp"),
		@Result(name = AbstractBaseAction.SAVE, location = "upmFileAction!edit.action",type=AbstractBaseAction.REDIRECT),
		@Result(name = AbstractBaseAction.LIST, location = "/jsp/upmFile/upmFileList.jsp", type=AbstractBaseAction.REDIRECT)
})
