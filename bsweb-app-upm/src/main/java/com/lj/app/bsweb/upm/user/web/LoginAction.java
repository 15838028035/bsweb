...
public class LoginAction extends AbstractBaseUpmAction<UpmUser> {
  ...
  public String login() throws Exception {
    ...
    if (StringUtil.isBlank(loginNo) || StringUtil.isBlank(pwd) || StringUtil.isBlank(identifyingCode)
        || StringUtil.isBlank(rand)) {
    ...
    if (isPermissionTree != null && isPermissionTree.equals("Y")) {
      Struts2Utils.getSession().setAttribute("isPermissionTree", isPermissionTree);
    } else {
