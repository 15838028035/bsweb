 ...
 * 
 *        * 请假流程Controller 流程特点:多级审批流程、decision节点的表达式写法->${day > 2 ? 'transition5' : 'transition4'} 业务数据:
 *        所有节点的业务数据均以json格式保存在order、task表的variable字段中 建议业务数据以独立的表保存，通过orderId来关联
 * 
 */
...
@Results({
    @Result(name = AbstractBaseAction.RELOAD, 
        location = "flowLeaveTestAction", type = AbstractBaseAction.REDIRECT),
    @Result(name = AbstractBaseAction.INPUT, 
        location = "/jsp/flowLeaveTest/flowLeaveTest-input.jsp"),
    @Result(name = "flowLeaveTestApply", 
        location = "/jsp/flowLeaveTest/flowLeaveTestApply.jsp"),
    @Result(name = "flowLeaveTestApplyView", 
        location = "/jsp/flowLeaveTest/flowLeaveTestApplyView.jsp"),
    @Result(name = "flowLeaveTestApproveDeptApp",
        location = "/jsp/flowLeaveTest/flowLeaveTestApproveDeptApp.jsp"),
    @Result(name = "flowLeaveTestApproveDeptView", 
        location = "/jsp/flowLeaveTest/flowLeaveTestApproveDeptView.jsp"),
    @Result(name = "flowLeaveTestBossApp", 
