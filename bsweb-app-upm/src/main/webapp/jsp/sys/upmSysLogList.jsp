	...
	var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#tableList').bootstrapTable({
                url: '${ctx}/jsp/sys/upmSysLogAction!bootStrapList.action',         //请求后台的URL（*）
                method: 'post',                     //请求方式（*）
                dataType: "json",
			...
			{ field: 'checkStatus', title: '',checkbox:true }, 
			 	...
			 	{field:'operation',title:'用户操作', sortable:true},
			 	{field:'method',title:'请求方法', sortable:true},
			 	{field:'params',title:'请求参数', sortable:true},
			 	{field:'ip',title:'IP地址', sortable:true},
			 	{field:'reateDate',title:'操作时间', sortable:true}
                        ],               		
...
<div class="panel-body" style="padding-bottom:0px;">
		...
		<sec:authorize code="upm_upmSysLogList_btn_delete" >
      ...
      $("#btn_delete").click(function() {
        ...
        function doDelete(){
            ...
            var result = jQuery.ajax({
		      	  url:"${ctx}/jsp/sys/upmSysLogAction!multidelete.action?multidelete=" + ids,
		          async:false,
		          cache:false,
		          dataType:"json"
		      }).responseText;
