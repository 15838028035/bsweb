	...
	var TableInit = function () {
        ...
        oTableInit.Init = function () {
			...
			{ field: 'checkStatus', title: '',checkbox:true }, 
			 	...
			 	{field:'operatorAmount',title:'报销金额', sortable:true},
      ...
      oTableInit.queryParams = function (params) {
            ...
            var temp = {   //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
				...
				"flowExpenseTest.operator":operator,
				"flowExpenseTest.operatorTimeBegin":operatorTimeBegin,
				"flowExpenseTest.operatorTimeEnd":operatorTimeEnd
            };
            return temp;
        };
        return oTableInit;
