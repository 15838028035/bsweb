	...
	var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#tableList').bootstrapTable({
                url: '${ctx}/jsp/upmRoleGroup/upmRoleGroupAction!bootStrapList.action',         //请求后台的URL（*）
                method: 'post',                     //请求方式（*）
                dataType: "json",
			...
			{ field: 'checkStatus', title: '',checkbox:true }, 
			 	...
			 	{field:'groupCode',title:'', sortable:true},
			 	{field:'appId',title:'', sortable:true},
			 	{field:'groupName',title:'', sortable:true},
			 	...
			 	{field:'enableFlag',title:'', sortable:true},
			 	{field:'lockStatus',title:'', sortable:true}
                        ],               		
      ...
      oTableInit.queryParams = function (params) {
		...
		"upmRoleGroup.id":id,
		"upmRoleGroup.groupCode":groupCode,
		"upmRoleGroup.appId":appId,
		"upmRoleGroup.groupName":groupName,
		"upmRoleGroup.createBy":createBy,
		"upmRoleGroup.createDateBegin":createDateBegin,
		"upmRoleGroup.createDateEnd":createDateEnd,
		"upmRoleGroup.updateBy":updateBy,
		"upmRoleGroup.updateDateBegin":updateDateBegin,
		"upmRoleGroup.updateDateEnd":updateDateEnd,
		"upmRoleGroup.enableFlag":enableFlag,
		"upmRoleGroup.lockStatus":lockStatus
            };
            return temp;
        };
        return oTableInit;
...
<div class="panel-body" style="padding-bottom:0px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				<div class="col-sm-2"> <input type="text" class="form-control" id="id"></div>
			 	...
			 	<label class="control-label col-sm-1" for="groupCode"></label>
				<div class="col-sm-2"> <input type="text" class="form-control" id="groupCode"></div>
                        
			 	<label class="control-label col-sm-1" for="appId"></label>
				<div class="col-sm-2"> <input type="text" class="form-control" id="appId"></div>
                        
			 	<label class="control-label col-sm-1" for="groupName"></label>
				<div class="col-sm-2"> <input type="text" class="form-control" id="groupName"></div>
			   ...
			   <div class="col-sm-2">
				...
				<input type="text" name="updateDateEnd" id = "updateDateEnd"  class="Wdate" onClick="WdatePicker()" readonly="readonly"/>
			 	...
			 	<label class="control-label col-sm-1" for="enableFlag"></label>
				<div class="col-sm-2"> <input type="text" class="form-control" id="enableFlag"></div>
                        
			 	<label class="control-label col-sm-1" for="lockStatus"></label>
    ...
    <script type="text/javascript">
        ...
        $("#btn_add").click(function() {
        	window.location.href = '${ctx}/jsp/upmRoleGroup/upmRoleGroupAction!input.action'
        })
		//编辑
        $("#btn_edit").click(function() {
        	...
        	window.location.href = "${ctx}/jsp/upmRoleGroup/upmRoleGroupAction!input.action?operate=edit&id=" + ids;
        })
		//删除
      $("#btn_delete").click(function() {
        ...
        function doDelete(){
            ...
            var result = jQuery.ajax({
		      	  url:"${ctx}/jsp/upmRoleGroup/upmRoleGroupAction!multidelete.action?multidelete=" + ids,
		          async:false,
		          cache:false,
		          dataType:"json"
		      }).responseText;
