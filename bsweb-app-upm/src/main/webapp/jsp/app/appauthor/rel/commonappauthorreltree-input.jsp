			...
			$(function (){
				...
				function getSelectIds(){
					...
					if("${isRevGrant}"=="Y"){
						...
						ids = tree.getCheckedAndHalfChecked();
					}
					ids = ids.toString();
					return ids;
				}
				...
				$("#saveRel").click(function(){
					...
					if(ids.toString() == selectIds){
						...
						if(delIds != ''){
							...
							if(typeof validateFuntionForTreeDelete !='undefined' && validateFuntionForTreeDelete instanceof Function ){
								validateFlag = 	validateFuntionForTreeDelete(delIds);
							}
						...
						if(result1 == "true" && (typeof(isUseAll) =='undefined' || isUseAll != "N" || addIds != '')){
							...
							var validateFlag = true;
							if(typeof validateFuntionForTreeSave !='undefined' && validateFuntionForTreeSave instanceof Function ){
								validateFlag = 	validateFuntionForTreeSave(addIds);
							}
							if(validateFlag != true){
								return;
							}
				...
				$("#updateRel").click(function(){
					...
					if( ids == ''|| ids == null){
						...
						var validateFlag = true;
						if(typeof validateFuntionForTreeUpdate !='undefined' && validateFuntionForTreeUpdate instanceof Function ){
							validateFlag = 	validateFuntionForTreeUpdate(ids);
						}
						if(validateFlag != true){
							return;
						}
