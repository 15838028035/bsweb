...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(function(){
			...
			$("#heightTable").css({"width":width*0.95,"height":height-28-40});
			...
			function add(){
		       var s = jQuery("#list").jqGrid('getGridParam',selectPara); 
				jQuery.FrameDialog.create({
					url: "${ctx}/jsp/app/appauthor/commonappauthormng!input.action?appCode=${appCode}&optype=${optype}&adminAcctSeq=${adminAcctSeq}&appId=${appId}&loginOrgId=${loginOrgId}&realAppId=${realAppId}&dirId="+$("#dirId").val(),
													...
													<td>
														<div style="clear: both">
															<c:forEach var="appAuthorTableConfig"
																items="${searchList}" varStatus="status">
																<div style="float: left;">
																	...
																	<c:if test="${appAuthorTableConfig.dataType =='5'}">
																		<c:choose>
																			<c:when
																				test="${!empty appAuthorTableConfig.dataSource}">
											...
											<c:if
												...
												<c:forEach var="appAuthorOptionGrant"
													...
													<c:if test="${appAuthorOptionGrant.isAttr!='Y'}">
														...
														<div
															class="window_button marg_lef10 float_lef buttongrant"
