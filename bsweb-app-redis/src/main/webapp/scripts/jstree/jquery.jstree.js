...
(function ($) {
	...
	$(function () {
		var css_string = '' + 
			'#vakata-contextmenu { display:block; visibility:hidden; left:0; top:-200px; position:absolute; margin:0; padding:0; min-width:75px; background:#ebebeb; border:1px solid silver; z-index:10000; *width:75px; } ' + 
			'#vakata-contextmenu ul { min-width:75px; *width:75px; } ' + 
