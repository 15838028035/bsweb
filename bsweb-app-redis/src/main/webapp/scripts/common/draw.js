...
SVGRenderer.prototype.addArrowColor = function(color) {
    ...
    marker.setAttributeNS(null, 'markerWidth', "5px");
...
SVGRenderer.prototype.hilight = function(shape) {

    shape.addEventListener("click", function() {

        this.setAttributeNS(null, "stroke", "black");
        this.setAttributeNS(null, "fill", "black");
        //this.setAttributeNS(null, "marker-end", "url(#blue)");
...
VMLRenderer.prototype.hilight = function(shape) {

    shape.onclick = function() {

        this.setAttribute('strokecolor', "black");
